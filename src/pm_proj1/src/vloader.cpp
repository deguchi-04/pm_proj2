...
/////////////////////////EXERCISE 1/////////////////////////////////////
void method1(string path, int mean, int std)
{
    ...
    ros::Publisher center_ball = n_center.advertise<geometry_msgs::Vector3>("vloarder/ball_center", 1);
    geometry_msgs::Vector3 center;
    center.x = ball_center.x;
    center.y = ball_center.y;
    center_ball.publish(center);
